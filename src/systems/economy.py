...
class EconomySystem(System):
    ...
    def _handle_crafting(self, state, df):
        ...
        # Identify Potential Crafters (Has materials, needs tool)
        # Simplify: Every tick, everyone tries to craft if they can.
        
        # Group inventory by agent
        # Optimization: We can't easily query "Who has 2 wood and 1 stone" in one go without complex pandas.
        # Let's iterate agents who HAVE wood/stone?
